...
public class DemoNoSQLTableBbqOrders extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableBbqOrders.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKey extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() throws AmazonClientException {
            ...
            result = mapper.load(BbqOrdersDO.class, "demo-id-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLBbqOrdersResult(result));
    ...
    public class DemoScanWithoutFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<BbqOrdersDO> results;
        private Iterator<BbqOrdersDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(BbqOrdersDO.class, scanExpression);
            if (results != null) {
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<BbqOrdersDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final BbqOrdersDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLBbqOrdersResult(item));
            itemsRetrieved++;
    ...
    public DemoNoSQLTableBbqOrders() {
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final BbqOrdersDO firstItem = new BbqOrdersDO();
        ...
        final BbqOrdersDO[] items = new BbqOrdersDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final BbqOrdersDO item = new BbqOrdersDO();
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        PaginatedScanList<BbqOrdersDO> results = mapper.scan(BbqOrdersDO.class, scanExpression);

        Iterator<BbqOrdersDO> resultsIterator = results.iterator();
        ...
        final List<BbqOrdersDO> batchOfItems = new LinkedList<BbqOrdersDO>();
