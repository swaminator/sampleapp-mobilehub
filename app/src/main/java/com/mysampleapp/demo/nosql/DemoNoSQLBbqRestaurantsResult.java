...
public class DemoNoSQLBbqRestaurantsResult implements DemoNoSQLResult {
    private static final int KEY_TEXT_COLOR = 0xFF333333;
    private final BbqRestaurantsDO result;

    DemoNoSQLBbqRestaurantsResult(final BbqRestaurantsDO result) {
        this.result = result;
    }
    @Override
