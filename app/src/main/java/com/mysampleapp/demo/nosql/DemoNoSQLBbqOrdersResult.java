...
import com.amazonaws.models.nosql.BbqOrdersDO;

import java.util.Set;

public class DemoNoSQLBbqOrdersResult implements DemoNoSQLResult {
    private static final int KEY_TEXT_COLOR = 0xFF333333;
    private final BbqOrdersDO result;

    DemoNoSQLBbqOrdersResult(final BbqOrdersDO result) {
        this.result = result;
    }
    @Override
