...
import com.amazonaws.models.nosql.BbqRestaurantsDO;
...
public class DemoNoSQLTableBbqRestaurants extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableBbqRestaurants.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKey extends DemoNoSQLOperationBase {
        private BbqRestaurantsDO result;
        ...
        public boolean executeOperation() throws AmazonClientException {
            ...
            result = mapper.load(BbqRestaurantsDO.class, "demo-id-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLBbqRestaurantsResult(result));
    ...
    public class DemoScanWithoutFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<BbqRestaurantsDO> results;
        private Iterator<BbqRestaurantsDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(BbqRestaurantsDO.class, scanExpression);
            if (results != null) {
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<BbqRestaurantsDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final BbqRestaurantsDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLBbqRestaurantsResult(item));
            itemsRetrieved++;
    ...
    public DemoNoSQLTableBbqRestaurants() {
        mapper = AWSMobileClient.defaultMobileClient().getDynamoDBMapper();
    }

    @Override
    public String getTableName() {
        return "bbq_restaurants";
    }
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final BbqRestaurantsDO firstItem = new BbqRestaurantsDO();

        firstItem.setId(
            DemoSampleDataGenerator.getRandomSampleString("id"));
        ...
        final BbqRestaurantsDO[] items = new BbqRestaurantsDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final BbqRestaurantsDO item = new BbqRestaurantsDO();
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        PaginatedScanList<BbqRestaurantsDO> results = mapper.scan(BbqRestaurantsDO.class, scanExpression);

        Iterator<BbqRestaurantsDO> resultsIterator = results.iterator();
        ...
        final List<BbqRestaurantsDO> batchOfItems = new LinkedList<BbqRestaurantsDO>();
