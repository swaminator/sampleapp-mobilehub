...
public class DemoNoSQLTableFactory {
    ...
    DemoNoSQLTableFactory(final Context context) {
        ...
        supportedTablesList.add(new DemoNoSQLTableBbqRestaurants());
        supportedTablesList.add(new DemoNoSQLTableBbqOrders());
        supportedTablesList.add(new DemoNoSQLTableBbqMenuItem());
